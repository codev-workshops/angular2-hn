...
| `.item` `padding: 10px 40px 0 40px` | `$space-10`, `$space-40`, `$space-0` |
| `.item` tablet `padding: 10px 20px 0 40px` | `$space-10`, `$space-20`, `$space-40` |
| `.item` mobile `padding: 110px 15px 0 15px` | `$space-110`, `$space-15` |
| `.head-margin` `margin-bottom: 15px` | `$space-15` |
| `p` `margin: 2px 0` | `$space-2`, `$space-0` |
...
| `.title-block` `margin: 0 75px` | `$space-0`, `$space-75` |
...
| `.item-header` mobile `padding: 10px 0 10px 0`, `top: 62px` | `$space-10`, `$space-0`, `$space-62` |
| `.pollContent .pollBar` `height: 10px` | `$size-poll-bar` |
| `ul` `padding: 10px 0` | `$space-10`, `$space-0` |
...
| `.deleted-meta` `font-size: 12px`, `margin: 30px 0` | `$font-size-xs`, `$space-30`, `$space-0` |
